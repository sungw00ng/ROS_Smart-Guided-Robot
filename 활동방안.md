...
<br>
<span style="background-color: orange;">주요 개발</span> 내용:<br>
...
<span style="background-color: orange;">주요 개발 과정 (Phase별)</span><br>
<br>
...
<br>
<span style="background-color: orange;">역할 분담 (팀원별 주요 역할)</span><br>
